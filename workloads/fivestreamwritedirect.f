...
define process name=seqwrite,instances=1
{
  ...
  {
    flowop write name=seqwrite1,filename=largefile1,iosize=$iosize,directio =  0
  }
  thread name=seqwrite2,memsize=10m,instances=$nthreads
  {
    flowop write name=seqwrite2,filename=largefile2,iosize=$iosize,directio = 0
  }
  thread name=seqwrite3,memsize=10m,instances=$nthreads
  {
    flowop write name=seqwrite3,filename=largefile3,iosize=$iosize,directio = 0
  }
